...
public class SimpleDB {
   ...
   // The following initialization methods are useful for 
     ...
     * Drop a database.
     *
     * First the file manager is closed, to prevent open files blocking the
     * deletion of the data files. Then all files in the database directory is
     * deleted and finally the directory is removed.
     *
     */
    public static void dropDatabase(String dirname) throws IOException {
        if (fm != null) {
            fm.close();
        }
