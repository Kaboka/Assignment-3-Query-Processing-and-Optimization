...
public class CreateStudentDB
{
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            {
                SimpleDB.planner().executeUpdate(s + studvals[i], tx);
            }
            ...
            {
                SimpleDB.planner().executeUpdate(s + deptvals[i], tx);
            }
            ...
            {
                SimpleDB.planner().executeUpdate(s + coursevals[i], tx);
            }
            ...
            {
                SimpleDB.planner().executeUpdate(s + sectvals[i], tx);
            }
            ...
            {
                SimpleDB.planner().executeUpdate(s + enrollvals[i], tx);
            }
